...
class MemoryRetrieverTest {
    ...
    @Test
    void shouldInjectUserIdentityMemoryForWhoAmIQuestion() {
        longTerm.store(new MemoryEntry("f1", "\u7528\u6237\u7684\u540d\u5b57\u53eb kcy",
                MemoryEntry.MemoryType.FACT, null, 5));

        String context = retriever.buildContextForQuery("\u6211\u662f\u8c01", 200);

        assertFalse(context.isEmpty());
        assertTrue(context.contains("\u7528\u6237\u7684\u540d\u5b57\u53eb kcy"));
    }
